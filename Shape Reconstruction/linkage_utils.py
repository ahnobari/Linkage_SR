...
class mechanism_solver():
    ...
    def get_standardized(self, x0, C, motor, fixed_nodes=[0, 1], show_msg=False):
...
def random_generator_ns(g_prob = 0.15, n=None, N_min=8, N_max=20, strategy='rand'):
    ...
    C,x,fixed_nodes = simplifier(C,x,fixed_nodes)
    
    C, x, fixed_nodes, motor = solver.get_standardized(x, C, motor, fixed_nodes, show_msg=False)
